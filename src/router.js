...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "solaatil-uulaa" */ "./views/tour/Tour.vue"
        ),
      name: "tour-salah",
    },
    {
      ...
      component: () =>
        import(/* webpackChunkName: "shart" */ "./views/shart/Shart.vue"),
      name: "shart",
    },
    {
      path: "/:madhhab/:gender/tahharah/:type(wudu)",
      component: () =>
        import(/* webpackChunkName: "wudu" */ "./views/wudu/Wudu.vue"),
      name: "wudu",
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "tahharah" */ "./views/tahharah/Tahharah.vue"
        ),
      name: "tahharah",
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "namaz" */ "./views/namaz-compare/NamazCompare.vue"
        ),
      name: "namaz-compare",
    },
    {
      ...
      component: () =>
        import(/* webpackChunkName: "namaz" */ "./views/namaz/Namaz.vue"),
      name: "namaz",
    },
    {
      path: "*",
